##############################################################################
context("RBC_algorithm_non_residence_rcpp")
##############################################################################

describe("Run RBC with a single non-resident person should succeed", {
  ...
  it("Scenario: 2. a non-resident who migrates", {
    j1 <-       c(journeyId = 1, 
                  personId = 1, 
                  is_arrival = 1, 
                  date_crossing = "2017-01-01", 
